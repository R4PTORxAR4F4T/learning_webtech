  ...
  <tr>
    ...
    <td class="tg-4fps" colspan="6" rowspan="2">
        <fieldset >
            ...
            <label for="">Current Password: </label><input type="text"><br><br>
            <label for="">New Password: </label><input type="text"><br><br>
            <label for="">Confirm Password: </label><input type="text"><br>
